      ...
      return (
        <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6 text-center font-sans">
          <div className="p-4 bg-amber-500/10 border-2 border-amber-500/40 rounded-3xl max-w-md space-y-4 shadow-2xl">
            ...
            <h2 className="text-lg font-black text-white">SurakshaAR Recovery Mode</h2>
            <p className="text-xs text-slate-300">
              The application encountered a hardware/device startup warning. Tap below to reload the safety simulator in Virtual 3D mode.
            </p>
            <button
              onClick={() => {
              ...
              className="px-6 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-slate-950 font-black rounded-2xl text-xs shadow-xl"
            >
